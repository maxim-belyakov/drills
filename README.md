...
| 2026-09-01 | 17 useState | 💻 | React week opens. Harness built first: real jsdom page, real React 19 root, JSX through esbuild-register, `npm run drill <file>`. Nothing mocked, so useState, events and controlled inputs behave as in a browser. Serves all seven React drills |
